...
var proto_message_pb = require('./message_pb.js');

function serialize_message_MessageRequest(arg) {
  if (!(arg instanceof proto_message_pb.MessageRequest)) {
...
function deserialize_message_MessageRequest(buffer_arg) {
  return proto_message_pb.MessageRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_message_MessageResponse(arg) {
  if (!(arg instanceof proto_message_pb.MessageResponse)) {
...
function deserialize_message_MessageResponse(buffer_arg) {
  return proto_message_pb.MessageResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var MessageServiceService = exports.MessageServiceService = {
  addMessage: {
    ...
    requestType: proto_message_pb.MessageRequest,
    responseType: proto_message_pb.MessageResponse,
